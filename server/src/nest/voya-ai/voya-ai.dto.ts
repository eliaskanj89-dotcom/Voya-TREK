import { voyaApplyDayEditRequestSchema, voyaApplyTripEditRequestSchema, voyaDayEditRequestSchema, voyaEditHistoryRequestSchema, voyaMaterializeDraftRequestSchema, voyaMaterializeMultiCityDraftRequestSchema, voyaMultiCityPlanRequestSchema, voyaPlanDraftRequestSchema, voyaRestoreEditSnapshotRequestSchema, voyaTripEditRequestSchema, voyaTripHealthRequestSchema, voyaVerifyTripRequestSchema, voyaReadinessBuildRequestSchema, voyaReadinessStatusRequestSchema, voyaReadinessToTodoRequestSchema, voyaDestinationDiscoveryRequestSchema, voyaDestinationResolveRequestSchema, voyaTransportAdviceRequestSchema } from '@trek/shared';
...
export class VoyaReadinessToTodoDto extends createZodDto(voyaReadinessToTodoRequestSchema) {}

export class VoyaTripHealthDto extends createZodDto(voyaTripHealthRequestSchema) {}
